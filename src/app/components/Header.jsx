...
<path d="M513.736 261.162C521.174 260.454 528.864 262.43 534.74 267.134C540.934 272.092 544.732 279.876 545.582 287.694C546.484 295.982 544.41 304.372 539.124 310.898C533.488 317.858 525.804 320.898 517.122 321.844C509.98 322.206 502.974 320.662 497.14 316.37C490.44 311.444 486.168 303.92 484.92 295.736C483.738 287.994 485.392 279.704 490.204 273.418C496.006 265.838 504.584 262.53 513.736 261.162Z" className="fill-secondary  "/>
        ...
        <div
          aria-hidden="true"
          className="fixed z-100 inset-0 h-screen overflow-y-hidden w-screen bg-quaternary/90 backdrop-blur-2xl origin-bottom scale-y-0 transition duration-500 peer-checked:origin-top peer-checked:scale-y-100 lg:hidden dark:bg-gray-900/70"
        />
        <div
