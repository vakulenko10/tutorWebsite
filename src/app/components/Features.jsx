      ...
      <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Проводимо зустріч щоб уточнити всі деталі та вибрати навчальний план. 
            </p>
          </div>
          <a
            href="#"
      ...
      <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Більшість зайнять складаються з виконання інтерактивних завдань та спілкування
            </p>
          </div>
          <a
            href="#"
      ...
      <div className="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Головний напрямок кожного плану чітко визначений, але можливо вибирати теми які вас більше цікавлять
            </p>
          </div>
          <a
            href="#"
      ...
      <div className="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
        <div className="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Зручний план. Обмежена можливість перенесення зайнять.
            </p>
          </div>
          <a
            href="#"
